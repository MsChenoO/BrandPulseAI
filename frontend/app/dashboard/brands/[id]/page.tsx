      ...
      <div className="card-modern p-2 animate-fade-in" style={{ animationDelay: '0.2s' }}>
        <div className="flex gap-2">
          <button
            ...
            className={`flex-1 px-3 sm:px-6 py-3 rounded-lg font-semibold transition-all ${
              activeTab === 'overview'
          ...
          >
            <span className="flex items-center justify-center gap-2">
              ...
              <span className="hidden sm:inline">Mentions ({totalMentions})</span>
              <span className="sm:hidden">{totalMentions}</span>
            </span>
          </button>
          <button
