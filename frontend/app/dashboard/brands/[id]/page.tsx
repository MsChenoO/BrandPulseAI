      ...
      <div className="card-modern p-2 animate-fade-in" style={{ animationDelay: '0.2s' }}>
        <div className="flex gap-2">
          <button
            ...
            className={`flex-1 px-2 md:px-6 py-3 rounded-lg font-semibold transition-all ${
              activeTab === 'overview'
          ...
          >
            <span className="flex items-center justify-center gap-2">
              ...
              <span className="hidden md:inline">Mentions ({totalMentions})</span>
              <span className="md:hidden">{totalMentions}</span>
            </span>
          </button>
        </div>
      </div>
